    ...
    <div style={styles.page}>
      ...
      <header style={styles.header}>
        <div>
          ...
          <p>Municipal Water Supply & Pipeline Management</p>
        </div>
...
/* ================= STYLES ================= */
const styles = {
  page: { height: "100vh", background: "#f0f9ff", fontFamily: "Segoe UI" },
  header: { background: "#0369a1", color: "#fff", padding: 20, display: "flex", justifyContent: "space-between" },
